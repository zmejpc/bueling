...
use ContactBundle\Form\Type\Dashboard\CallbackMailSettingType;
 ...
 */
class CallbackMailSettingController extends CRUDController
{
    ...
    public function getRouteElements(): array
    {
        return [
            'index' => null, 'new' => null,
            'edit' => 'dashboard_callback_mail_setting_edit', 'delete' => null,
        ];
    }
    ...
    {
        return CallbackMailSettingType::class;
    }

    public function getFormElement()
    {
        return new CallbackMailSetting();
    }

    public function getRepository(EntityManagerInterface $em)
    {
        $repository = $em->getRepository(CallbackMailSetting::class);
