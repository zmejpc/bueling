...
class ContactManager
{
    ...
    public function createContactMailSetting()
    {
        ...
        $object->translate($this->locale)->setMessageBody('Message Body');
        $object->translate($this->locale)->setMessageSubject('Message Subject');
