...
trait sidebarUserBundleTrait
{
     ...
     * @return array|null
     */
    private function sidebarUserBundle(): ?array
    {
        $user = self::itemSidebar(
            ['ROLE_USERS_EDIT'], ['user/edit/', 'user/setting/mail/edit'], [
            'dashboard_user_index', 'dashboard_user_mail_setting_index',
            'dashboard_user_mail_setting_new'
        ],
            'flaticon-users', false, null, null,
            'sidebar.customers.users', [], 'dashboard_user_index', 'UserBundle', true,
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        if (!is_null($user)) {
            $mail = self::itemSidebar(['ROLE_DEVELOPER'], ['user/setting/mail/edit'], [
                'dashboard_user_mail_setting_index', 'dashboard_user_mail_setting_new'
            ],
                'flaticon-multimedia-2', false, null, null,
                'sidebar.customers.user_settings.user_mail_setting', [],
                'dashboard_user_mail_setting_index', 'UserBundle', true,
                '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M1.98505595,18 L1.98505595,13 C1.98505595,11.8954305 2.88048645,11 3.98505595,11 L11.9850559,11 C13.0896254,11 13.9850559,11.8954305 13.9850559,13 L13.9850559,18 C13.9850559,19.1045695 13.0896254,20 11.9850559,20 L4.10078614,20 L2.85693427,21.1905292 C2.65744295,21.3814685 2.34093638,21.3745358 2.14999706,21.1750444 C2.06092565,21.0819836 2.01120804,20.958136 2.01120804,20.8293182 L2.01120804,18.32426 C1.99400175,18.2187196 1.98505595,18.1104045 1.98505595,18 Z M6.5,14 C6.22385763,14 6,14.2238576 6,14.5 C6,14.7761424 6.22385763,15 6.5,15 L11.5,15 C11.7761424,15 12,14.7761424 12,14.5 C12,14.2238576 11.7761424,14 11.5,14 L6.5,14 Z M9.5,16 C9.22385763,16 9,16.2238576 9,16.5 C9,16.7761424 9.22385763,17 9.5,17 L11.5,17 C11.7761424,17 12,16.7761424 12,16.5 C12,16.2238576 11.7761424,16 11.5,16 L9.5,16 Z" id="Combined-Shape" fill="#000000" opacity="0.3"/>
            ...
            $_user = self::itemSidebar(
                ['ROLE_USERS_EDIT'], ['user/edit/'], ['dashboard_user_index'],
                'flaticon-users', false, null, null,
                'sidebar.customers.users', [], 'dashboard_user_index', 'UserBundle', true,
                '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M7.00036205,16.4995035 C7.21569918,13.5165724 9.36772908,12 11.9907452,12 C14.6506758,12 16.8360465,13.4332455 16.9988413,16.5 C17.0053266,16.6221713 16.9988413,17 16.5815,17 C14.5228466,17 11.463736,17 7.4041679,17 C7.26484009,17 6.98863236,16.6619875 7.00036205,16.4995035 Z" id="Mask-Copy" fill="#000000" opacity="0.3"/>
            ...
            (!is_null($_user)) ? $user['items'][] = $_user : null;
            (!is_null($mail)) ? $user['items'][] = $mail : null;
        }
