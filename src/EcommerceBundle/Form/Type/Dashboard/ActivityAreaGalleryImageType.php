 ...
 */
class ActivityAreaGalleryImageType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('image', UploadType::class, [
                'file_type' => 'activity_area_gallery_image',
    ...
    {
        $resolver->setDefaults(['data_class' => ActivityAreaGalleryImage::class, 'grantedRoles' => null]);
    }
}