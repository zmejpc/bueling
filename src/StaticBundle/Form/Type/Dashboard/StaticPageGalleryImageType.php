...
use StaticBundle\Entity\StaticPageGalleryImage;
 ...
 */
class StaticPageGalleryImageType extends AbstractType
{
    ...
    {
        $resolver->setDefaults(['data_class' => StaticPageGalleryImage::class, 'grantedRoles' => null]);
    }
}